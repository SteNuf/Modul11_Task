...
function OverView() {
  return (
    <div className="overview-container">
      <div className="overview-foto">photo</div>
      <div className="overview-person">
        <div className="overview-username">Username</div>
        <div className="overview-details">
          <div className="overview-leftside">
            <div className="overview-birth">
              <svg
          ...
          <div className="overview-rightside">
            <div className="overview-address">
              ...
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className="overview-adress-icon"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <div className="overview-website">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
                stroke="currentColor"
                className="overview-website-icon"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
